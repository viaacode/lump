"""
Module providing our own CSV file parser with support for whitespace trimming,
empty lines filtering and comment lines.
...
from lump.helpers import DeferredList, make_printable
